/*******************************************************************************
 * Author    :  Angus Johnson  * Date      :  22 January 2025
...
// Square : Joins are 'squared' at exactly the offset distance (more complex
// code) Bevel  : Similar to Square, but the offset distance varies with angle
// (simple code & faster)
...
typedef std::function<double(const Path64 &path, const PathD &path_normals,
...
private:
  ...
  void ZCB(const Point64 &bot1, const Point64 &top1, const Point64 &bot2,
           const Point64 &top2, Point64 &ip);
#endif
