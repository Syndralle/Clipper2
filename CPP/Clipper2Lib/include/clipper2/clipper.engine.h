/*******************************************************************************
 * Author    :  Angus Johnson  * Date      :  17 September 2024
 *                              * Website   :  https://www.angusj.com
 *                               * Copyright :  Angus Johnson 2010-2024
 *                                * Purpose   :  This is the main polygon
 * clipping module                        * License   :
...
public:
  ...
  ~PolyPath64() override { childs_.resize(0); }
...
public:
  ...
  ~PolyPathD() override { childs_.resize(0); }
...
public:
  ...
  void ZCB(const Point64 &e1bot, const Point64 &e1top, const Point64 &e2bot,
  ...
  void CheckCallback() {
    if (zCallbackD_)
      ...
      ClipperBase::zCallback_ = std::bind(
          &ClipperD::ZCB, this, std::placeholders::_1, std::placeholders::_2,
