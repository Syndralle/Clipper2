/*******************************************************************************
 * Author    :  Angus Johnson  * Date      :  11 October 2025
...
bool GetSegmentIntersection(const Point64 &p1, const Point64 &p2,
                            const Point64 &p3, const Point64 &p4, Point64 &ip) {
...
inline bool GetIntersection(const Path64 &rectPath, const Point64 &p,
                            const Point64 &p2, Location &loc, Point64 &ip) {
...
inline bool IsHeadingClockwise(const Point64 &pt1, const Point64 &pt2,
                               int edgeIdx) {
  switch (edgeIdx) {
  case 0:
    return pt2.y < pt1.y;
...
void RectClip64::GetNextLocation(const Path64 &path, Location &loc, size_t &i,
                                 size_t highI) {
  switch (loc) {
  case Location::Left:
