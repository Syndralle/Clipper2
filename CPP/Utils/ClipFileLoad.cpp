...
bool GetInt(string::const_iterator &s_it, const string::const_iterator &it_end,
            int64_t &value) {
  value = 0;
...
bool LoadTestNum(ifstream &source, int test_num, Paths64 &subj,
                 Paths64 &subj_open, Paths64 &clip, int64_t &area,
