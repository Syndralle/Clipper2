...
TEST(Clipper2Tests, TestRectClip) {
  ...
  EXPECT_TRUE(sol.empty());
  sub.clear();
  sub.push_back(MakePath({208, 66, 366, 112, 402, 303, 234, 332, 233, 262, 243,
                          140, 215, 126, 40, 172}));
...
TEST(Clipper2Tests, TestRectClip2) // #597
{
  ...
  Clipper2Lib::Paths64 subject{
      {{700000, 6000}, {0, 6000}, {0, 5925}, {700000, 5925}}};
...
TEST(Clipper2Tests, TestRectClip3) // #637
{
  ...
  subject.push_back(
      MakePath({-1800000000LL, 10005000LL, -1800000000LL, -5000LL,
                -1789994999LL, -5000LL, -1789994999LL, 10005000LL}));
...
TEST(Clipper2Tests, TestRectClipOrientation) // #864
{
  ...
  const Path64 subject =
      MakePath({375, 1680, 1915, 4716, 5943, 586, 3987, 152});
